class ArtsController < ApplicationController
  ...
  def authorize
      ...
      gon.global.username_response = HTTParty.get("https://www.deviantart.com/api/v1/oauth2/user/whoami?"+"access_token="+gon.global.acces_token_response[:access_token].to_s)
